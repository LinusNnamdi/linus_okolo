...
const resources = [
    ...
    // ---------- GitHub Actions (10) ----------
    {
        ...
        title: "GitHub Actions CI Pipeline for Node.js",
        description: "Automated continuous integration with linting, unit tests, coverage reporting, and matrix testing across Node versions.",
        difficulty: "Beginner",
        technologies: ["GitHub Actions", "Node.js", "npm", "ESLint", "Jest", "Matrix"],
        ...
        useCases: ["Open-source Node projects", "Team CI gates", "Multi-version compatibility testing"],
        services: ["GitHub Actions", "GitHub Packages (optional)", "Codecov / Coveralls"],
        implementationSteps: [
            "Create .github/workflows/ci.yml",
            "Define triggers for push and pull_request",
            "Add strategy.matrix for Node versions",
            "Configure actions/checkout and actions/setup-node with caching",
            "Run npm ci, lint, and test scripts",
            "Upload coverage artifacts or report to external service",
            "Add status checks required for branch protection",
            "Test on feature branch and verify matrix results",
            "Document required secrets and environment variables",
            "Refine failure notifications via Slack or email"
        ],
        security: "Least-privilege GITHUB_TOKEN permissions, dependency review action, no secrets in logs.",
        scalability: "Matrix jobs scale with runners; caching reduces install time significantly.",
        monitoring: "Workflow run history, job duration, test failure trends, coverage trends.",
        complexity: "Beginner."
    },
    {
        id: 52,
        platform: "GitHub Actions",
        title: "GitHub Actions Docker Build & Push Pipeline",
        description: "Build, scan, tag, and push multi-architecture container images to a registry on every release or main branch push.",
        difficulty: "Intermediate",
        technologies: ["GitHub Actions", "Docker", "Buildx", "GHCR", "Trivy", "Cosign"],
        image: "../../images/cloud/51_60/2_1.jpg",
        gallery: [
        ...
        useCases: ["Microservices release pipelines", "Multi-arch support", "Secure supply-chain image publishing"],
        services: ["GitHub Actions", "GitHub Container Registry", "Docker Hub", "Trivy", "Cosign"],
        implementationSteps: [
            "Create workflow triggered on push to main and tags",
            "Set up QEMU and Buildx for multi-arch",
            "Login to target registry with secrets",
            "Build and push with cache and provenance",
            "Run Trivy vulnerability scan and fail on critical",
            "Optionally sign images with Cosign",
            "Generate SBOM and attach as attestation",
            "Use immutable tags (git SHA) plus latest/semver",
            "Test pull and run from registry",
            "Document promotion strategy between environments"
        ],
        security: "OIDC or short-lived tokens, scan-on-push, signed images, least-privilege registry permissions.",
        scalability: "Buildx parallel platforms and layer caching keep builds fast as the project grows.",
        monitoring: "Build duration, scan findings over time, registry pull metrics.",
        complexity: "Intermediate."
    },
    {
        id: 53,
        platform: "GitHub Actions",
        title: "GitHub Actions Multi-Environment CD Pipeline",
        description: "Progressive delivery across development, staging, and production environments with manual approvals and environment protection rules.",
        difficulty: "Intermediate",
        technologies: ["GitHub Actions", "Environments", "Deployment", "OIDC", "Approval Gates"],
        ...
        useCases: ["SaaS product releases", "Regulated environments", "Blue/green or canary promotion"],
        services: ["GitHub Environments", "GitHub Actions", "Cloud providers via OIDC"],
        implementationSteps: [
            "Define development, staging, and production environments in repository settings",
            "Configure required reviewers and wait timers for production",
            "Create workflow with build job producing artifacts",
            "Add deploy jobs that depend on previous environment success",
            "Use environment: key for secrets and protection rules",
            "Implement OIDC authentication to cloud providers",
            "Add deployment status checks and notifications",
            "Test full promotion path including rejection of approval",
            "Document rollback procedure per environment",
            "Review environment secrets regularly"
        ],
        security: "Environment protection rules, short-lived OIDC tokens, no long-lived cloud keys in secrets.",
        scalability: "Reusable workflows and matrix deployments support many services.",
        monitoring: "Deployment history per environment, approval latency, failure rates.",
        complexity: "Intermediate."
    },
    {
        id: 54,
        platform: "GitHub Actions",
        title: "GitHub Actions Terraform Infrastructure Pipeline",
        description: "Infrastructure-as-Code CI/CD with plan on pull request, apply on merge, state locking, and policy checks.",
        difficulty: "Advanced",
        technologies: ["GitHub Actions", "Terraform", "TFLint", "Checkov", "OIDC", "Remote State"],
        ...
        useCases: ["Cloud landing zones", "Multi-account infrastructure", "Compliance-driven IaC"],
        services: ["GitHub Actions", "Terraform Cloud / S3 + DynamoDB", "AWS / Azure / GCP via OIDC"],
        implementationSteps: [
            "Store Terraform code in repository with remote backend configuration",
            "Create workflow triggered on pull_request and push to main",
            "Authenticate with OIDC to the target cloud",
            "Run terraform fmt, init, validate, and tflint",
            "Execute terraform plan and upload plan artifact",
            "Post plan summary as pull-request comment",
            "On main branch, download plan and run terraform apply",
            "Add Checkov or similar policy-as-code scan",
            "Protect main branch and require status checks",
            "Document state backend and disaster recovery"
        ],
        security: "OIDC only (no static keys), state encryption, least-privilege IAM roles, policy gates.",
        scalability: "Workspaces or separate state files per environment; modular Terraform design.",
        monitoring: "Plan/apply duration, drift detection runs, failed applies.",
        complexity: "Advanced."
    },
    {
        id: 55,
        ...
        description: "Shift-left security with dependency review, SAST, secret scanning, container scanning, and SARIF upload to GitHub code scanning.",
        difficulty: "Intermediate",
        technologies: ["GitHub Actions", "CodeQL", "Dependabot", "Trivy", "Gitleaks", "SARIF"],
        ...
        useCases: ["Secure software supply chain", "Compliance evidence", "Open-source project hardening"],
        services: ["GitHub Advanced Security", "CodeQL", "Dependabot", "Trivy"],
        implementationSteps: [
            "Enable GitHub Advanced Security or code scanning",
            "Add dependency-review-action on pull requests",
            "Configure CodeQL workflow for supported languages",
            "Add Gitleaks or trufflehog for secret scanning",
            "Scan Dockerfiles and built images with Trivy",
            "Upload all results as SARIF",
            "Set branch protection rules requiring security checks",
            "Configure Dependabot alerts and automatic PRs",
            "Review and triage findings in Security tab",
            "Document false-positive handling process"
        ],
        security: "No secrets in workflow logs, least-privilege permissions, regular action version pinning.",
        scalability: "Parallel jobs and incremental CodeQL analysis keep feedback fast.",
        monitoring: "Open alerts trend, mean time to remediate, scan coverage.",
        complexity: "Intermediate."
    },
    {
        id: 56,
        platform: "GitHub Actions",
        title: "GitHub Actions Monorepo CI/CD Pipeline",
        description: "Path-filtered workflows, affected package detection, and selective builds/tests for large monorepos.",
        difficulty: "Advanced",
        technologies: ["GitHub Actions", "Monorepo", "Path Filters", "Nx / Turborepo", "Matrix"],
        ...
        useCases: ["Large frontend/backend monorepos", "Multi-package libraries", "Platform engineering teams"],
        services: ["GitHub Actions", "Nx Cloud / Turborepo Remote Cache (optional)"],
        implementationSteps: [
            "Structure repository with clear package boundaries",
            "Add path filters so unrelated changes skip expensive jobs",
            "Implement affected-package detection script or use Nx/Turborepo",
            "Generate dynamic matrix of packages to build/test",
            "Configure shared dependency and build caches",
            "Run lint, test, and build only for affected packages",
            "Publish only changed packages on release",
            "Add concurrency groups to cancel outdated runs",
            "Measure and optimise average pipeline duration",
            "Document ownership of packages and CI ownership"
        ],
        security: "Scoped tokens per package where possible, dependency scanning still applied globally.",
        scalability: "Selective execution keeps CI time manageable as the monorepo grows.",
        monitoring: "Per-package success rates, cache hit ratios, average duration of affected runs.",
        complexity: "Advanced."
    },
    {
        id: 57,
        platform: "GitHub Actions",
        title: "GitHub Actions Self-Hosted Runners Architecture",
        description: "Secure, scalable self-hosted runner deployment with auto-scaling, labels, and network isolation for private workloads.",
        difficulty: "Advanced",
        technologies: ["GitHub Actions", "Self-hosted Runners", "Docker", "Kubernetes", "Autoscaling"],
        ...
        useCases: ["Private package registries", "GPU or specialised hardware", "Air-gapped or regulated environments"],
        services: ["GitHub Actions", "Actions Runner Controller", "Kubernetes / VMs"],
        implementationSteps: [
            "Decide between persistent and ephemeral runners",
            "Create runner groups and apply repository or organisation access",
            "Deploy Actions Runner Controller or custom autoscaler",
            "Configure labels for OS, architecture, and capabilities",
            "Harden runner images (non-root, minimal packages)",
            "Implement network isolation and egress controls",
            "Set up monitoring of runner utilisation and job queue",
            "Rotate registration tokens and audit runner access",
            "Test job routing with runs-on labels",
            "Document capacity planning and cost controls"
        ],
        security: "Ephemeral runners, least-privilege IAM, network policies, no long-lived credentials on runners.",
        scalability: "Autoscaling based on queue depth or scheduled capacity.",
        monitoring: "Runner online status, job wait time, utilisation metrics.",
        complexity: "Advanced."
    },
    {
        id: 58,
        platform: "GitHub Actions",
        title: "GitHub Actions Kubernetes Deployment Pipeline",
        description: "Build, scan, and deploy to Kubernetes using kubectl, Helm, or Kustomize with GitOps-friendly patterns and progressive delivery.",
        difficulty: "Advanced",
        technologies: ["GitHub Actions", "Kubernetes", "Helm", "Kustomize", "kubectl", "OIDC"],
        ...
        useCases: ["Microservices on EKS/AKS/GKE", "GitOps hybrid pipelines", "Multi-cluster promotion"],
        services: ["GitHub Actions", "Amazon EKS / AKS / GKE", "Helm", "Kustomize"],
        implementationSteps: [
            "Build and push image with unique tag (git SHA)",
            "Authenticate to Kubernetes cluster via OIDC or secrets",
            "Update image references in Kustomize overlays or Helm values",
            "Apply manifests or run helm upgrade --install",
            "Wait for rollout status and perform smoke tests",
            "Optionally integrate progressive delivery (Argo Rollouts / Flagger)",
            "Add post-deployment notifications and status checks",
            "Implement automatic rollback on failed health checks",
            "Protect production environment with required reviewers",
            "Document cluster access model and break-glass procedure"
        ],
        security: "OIDC or short-lived tokens, least-privilege service accounts, image signing verification optional.",
        scalability: "Parallel deployments to multiple clusters or namespaces via matrix.",
        monitoring: "Rollout duration, deployment success rate, post-deploy error rates.",
        complexity: "Advanced."
    },
    {
        id: 59,
        platform: "GitHub Actions",
        title: "GitHub Actions Reusable Workflows & Composite Actions",
        description: "Organisation-wide reusable workflows and composite actions for consistent CI/CD standards and reduced duplication.",
        difficulty: "Intermediate",
        technologies: ["GitHub Actions", "Reusable Workflows", "Composite Actions", "Organisation"],
        ...
        useCases: ["Enterprise standardisation", "Platform team offerings", "Reducing boilerplate across dozens of repositories"],
        services: ["GitHub Actions", "GitHub Organisations"],
        implementationSteps: [
            "Create a central actions/workflows repository",
            "Extract common jobs into reusable workflows with inputs",
            "Build composite actions for repeated step groups (setup, scan, notify)",
            "Version reusable workflows with tags or branches",
            "Document required inputs, secrets, and permissions",
            "Migrate pilot repositories to call the reusable workflows",
            "Enforce usage via organisation rules or required workflows",
            "Add integration tests for the reusable components themselves",
            "Publish changelog and migration guide",
            "Monitor adoption and gather feedback for improvements"
        ],
        security: "Explicit permissions in called workflows, pinned action versions, organisation-level secret management.",
        scalability: "One change in the central workflow benefits all consuming repositories.",
        monitoring: "Usage metrics of reusable workflows, failure rates of shared components.",
        complexity: "Intermediate."
    },
    {
        id: 60,
        platform: "GitHub Actions",
        title: "GitHub Actions Release Automation Pipeline",
        description: "Automated semantic versioning, changelog generation, GitHub Releases, and package publishing triggered by conventional commits.",
        difficulty: "Intermediate",
        technologies: ["GitHub Actions", "semantic-release", "Conventional Commits", "Changelog", "npm / PyPI"],
        ...
        useCases: ["Library and SDK publishing", "Consistent versioning across services", "Open-source release automation"],
        services: ["GitHub Actions", "GitHub Releases", "npm / PyPI / Maven / etc."],
        implementationSteps: [
            "Adopt conventional commit messages in the repository",
            "Add semantic-release or equivalent tool configuration",
            "Create workflow that runs on main branch pushes",
            "Configure authentication for package registries",
            "Generate and commit changelog if required",
            "Create GitHub Release with generated notes",
            "Publish packages with the calculated version",
            "Add dry-run mode for pull requests",
            "Protect main branch and require status checks",
            "Document commit message conventions for contributors"
        ],
        security: "Fine-grained tokens or OIDC for publishing, no manual version bumps, audit trail via GitHub Releases.",
        scalability: "Works for single packages or coordinated multi-package releases in monorepos.",
        monitoring: "Release frequency, time-to-release after merge, failed publish attempts.",
        complexity: "Intermediate."
    },
    // ---------- Terraform (9) ----------
    {
        id: 61,
        platform: "Terraform",
        title: "Terraform AWS Multi-AZ VPC Foundation",
        description: "Reusable Terraform module that provisions a production-ready multi-AZ VPC with public/private subnets, NAT Gateways, route tables, and flow logs.",
        difficulty: "Intermediate",
        technologies: ["Terraform", "AWS", "VPC", "NAT Gateway", "Modules"],
        ...
        useCases: ["Landing zone networking", "Multi-tier application foundation", "Reusable network module for teams"],
        services: ["Amazon VPC", "NAT Gateway", "Internet Gateway", "VPC Flow Logs", "Terraform"],
        implementationSteps: [
            "Define input variables for CIDR, AZ count, and feature flags",
            "Create VPC and enable DNS support/hostnames",
            "Provision public and private subnets across AZs",
            "Attach Internet Gateway and configure public routes",
            "Deploy NAT Gateways and private route tables",
            "Add optional Network ACLs and security group defaults",
            "Enable VPC Flow Logs to S3 or CloudWatch",
            "Output subnet IDs, route table IDs, and VPC ID",
            "Write module documentation and examples",
            "Publish to a private module registry or Git source"
        ],
        security: "Least-privilege IAM for Terraform execution, encrypted flow logs, no public access by default.",
        scalability: "Variable-driven AZ count and CIDR sizing support growth without redesign.",
        monitoring: "VPC Flow Logs, Terraform state drift detection, apply success metrics.",
        complexity: "Intermediate."
    },
    {
        id: 62,
        platform: "Terraform",
        title: "Terraform Azure Landing Zone",
        description: "Enterprise-scale Azure landing zone implemented with Terraform, covering management groups, subscriptions, networking, and identity.",
        difficulty: "Advanced",
        technologies: ["Terraform", "Azure", "Landing Zone", "Management Groups", "Azure AD"],
        ...
        useCases: ["Enterprise cloud adoption", "Multi-subscription organisations", "Regulated industry landing zones"],
        services: ["Azure Management Groups", "Azure Virtual Network", "Azure Firewall", "Azure Policy", "Terraform"],
        implementationSteps: [
            "Model management group and subscription hierarchy",
            "Implement subscription creation or association logic",
            "Deploy hub virtual network and shared services",
            "Create spoke VNets and configure peering or vWAN",
            "Assign Azure Policies and initiatives",
            "Configure Azure AD groups and role assignments",
            "Enable diagnostic settings and Log Analytics",
            "Parameterise environments (dev/test/prod)",
            "Add remote state and locking",
            "Document governance and change process"
        ],
        security: "Azure AD authentication, least-privilege RBAC, Azure Policy guardrails, private endpoints where possible.",
        scalability: "Subscription vending and modular design support hundreds of workloads.",
        monitoring: "Azure Monitor, Policy compliance dashboards, Terraform apply history.",
        complexity: "Advanced."
    },
    {
        id: 63,
        platform: "Terraform",
        title: "Terraform Google Cloud Project Factory",
        description: "Automated GCP project creation with Terraform including APIs, IAM, networking, and budget alerts using the Project Factory pattern.",
        difficulty: "Intermediate",
        technologies: ["Terraform", "GCP", "Project Factory", "IAM", "Cloud Billing"],
        ...
        useCases: ["Multi-project organisations", "Developer self-service", "Environment isolation"],
        services: ["Google Cloud Resource Manager", "Cloud IAM", "Shared VPC", "Cloud Billing", "Terraform"],
        implementationSteps: [
            "Define project naming and folder hierarchy",
            "Create Terraform module for project provisioning",
            "Enable required Google APIs",
            "Configure IAM bindings for owners, editors, and viewers",
            "Attach project to Shared VPC host project",
            "Set up billing budget and threshold alerts",
            "Apply organisation policies and constraints",
            "Output project ID and service account emails",
            "Add example configurations for different environments",
            "Integrate with CI for automated project requests"
        ],
        security: "Organisation policy constraints, least-privilege IAM, service account key avoidance.",
        scalability: "Module can be called repeatedly for dozens of projects.",
        monitoring: "Billing alerts, API enablement status, IAM drift detection.",
        complexity: "Intermediate."
    },
    {
        id: 64,
        platform: "Terraform",
        title: "Terraform EKS Cluster Module",
        description: "Production-grade Amazon EKS cluster provisioned with Terraform including managed node groups, IRSA, add-ons, and private networking.",
        difficulty: "Advanced",
        technologies: ["Terraform", "AWS", "EKS", "IRSA", "Managed Node Groups"],
        ...
        useCases: ["Platform teams", "Production Kubernetes on AWS", "Multi-tenant EKS environments"],
        services: ["Amazon EKS", "IAM Roles for Service Accounts", "VPC CNI", "Terraform"],
        implementationSteps: [
            "Create or reference existing VPC and private subnets",
            "Provision EKS cluster with desired Kubernetes version",
            "Configure managed node groups with scaling parameters",
            "Enable OIDC provider and create IRSA roles",
            "Install core add-ons via Terraform or Helm",
            "Configure cluster security groups and endpoint access",
            "Add optional Karpenter or Cluster Autoscaler",
            "Output kubeconfig and OIDC issuer URL",
            "Write integration tests with terratest",
            "Document upgrade and node rotation procedures"
        ],
        security: "Private endpoints, IRSA, encryption at rest, pod security standards, least-privilege node roles.",
        scalability: "Managed node groups and cluster autoscaler support dynamic capacity.",
        monitoring: "Control plane logs, CloudWatch Container Insights, Terraform state monitoring.",
        complexity: "Advanced."
    },
    {
        id: 65,
        platform: "Terraform",
        title: "Terraform Remote State & Backend Architecture",
        description: "Secure remote state management with S3 + DynamoDB, Azure Storage, or GCS, including state locking, encryption, and workspace strategies.",
        difficulty: "Intermediate",
        technologies: ["Terraform", "Remote State", "S3", "DynamoDB", "Workspaces"],
        ...
        useCases: ["Team collaboration", "CI/CD pipelines", "Multi-environment state isolation"],
        services: ["Amazon S3", "DynamoDB", "AWS KMS", "Terraform Backend"],
        implementationSteps: [
            "Create encrypted and versioned storage bucket",
            "Provision locking table or equivalent mechanism",
            "Configure backend block in Terraform code",
            "Enable server-side encryption and access logging",
            "Define IAM policies for state access",
            "Choose workspace or separate-state strategy",
            "Migrate existing local state if required",
            "Add state backup and recovery runbooks",
            "Restrict who can run terraform destroy",
            "Document backend configuration for all teams"
        ],
        security: "Encryption at rest, least-privilege IAM, no public access, state locking to prevent concurrent writes.",
        scalability: "Supports many concurrent workspaces and large state files.",
        monitoring: "State file version history, lock contention metrics, access logs.",
        complexity: "Intermediate."
    },
    {
        id: 66,
        platform: "Terraform",
        title: "Terraform Module Design & Registry",
        description: "Best-practice reusable Terraform modules with versioning, input validation, outputs, and publication to a private module registry.",
        difficulty: "Intermediate",
        technologies: ["Terraform", "Modules", "Registry", "Validation", "Versioning"],
        ...
        useCases: ["Platform engineering", "Standardised infrastructure components", "Reducing duplication across teams"],
        services: ["Terraform Module Registry", "Git", "Terratest (optional)"],
        implementationSteps: [
            "Adopt standard module directory structure",
            "Define clear input variables with types and validation",
            "Expose useful outputs and document them",
            "Pin provider versions in versions.tf",
            "Write examples and comprehensive README",
            "Add automated tests with terratest or similar",
            "Tag releases using semantic versioning",
            "Publish to private registry or document Git source usage",
            "Create consumption guidelines for teams",
            "Establish deprecation and upgrade policy"
        ],
        security: "No secrets in modules, least-privilege examples, signed releases optional.",
        scalability: "Well-designed modules are consumed by dozens of root modules.",
        monitoring: "Module download/usage metrics, version adoption, test pass rates.",
        complexity: "Intermediate."
    },
    {
        id: 67,
        platform: "Terraform",
        title: "Terraform + Terragrunt Multi-Environment Setup",
        description: "DRY multi-environment infrastructure using Terragrunt for remote state, dependency management, and environment promotion.",
        difficulty: "Advanced",
        technologies: ["Terraform", "Terragrunt", "DRY", "Dependencies", "Environments"],
        ...
        useCases: ["Large multi-account setups", "Complex dependency graphs", "Consistent environment promotion"],
        services: ["Terragrunt", "Terraform", "Remote State Backends"],
        implementationSteps: [
            "Install and configure Terragrunt",
            "Create hierarchical directory structure for environments",
            "Define root terragrunt.hcl with remote state generation",
            "Create environment-level and component-level configs",
            "Express dependencies between components",
            "Use generate blocks for provider and backend files",
            "Implement plan-all and apply-all patterns carefully",
            "Add CI integration for terragrunt run-all",
            "Document how to add new environments and components",
            "Establish promotion process from dev to prod"
        ],
        security: "Inherited remote state encryption, environment isolation, restricted apply permissions in production.",
        scalability: "Handles hundreds of components across many environments with minimal duplication.",
        monitoring: "Terragrunt run logs, dependency graph visualisation, apply success per component.",
        complexity: "Advanced."
    },
    {
        id: 68,
        platform: "Terraform",
        title: "Terraform Policy as Code with OPA / Sentinel",
        description: "Enforce security and compliance guardrails on Terraform plans using Open Policy Agent (OPA) or HashiCorp Sentinel before apply.",
        difficulty: "Advanced",
        technologies: ["Terraform", "OPA", "Sentinel", "Policy as Code", "CI"],
        ...
        useCases: ["Compliance enforcement", "Cost control", "Security guardrails across teams"],
        services: ["Open Policy Agent", "HashiCorp Sentinel", "Terraform Cloud", "GitHub Actions / CI"],
        implementationSteps: [
            "Identify mandatory organisational policies",
            "Author Rego or Sentinel policies for common controls",
            "Integrate plan evaluation into CI pipeline",
            "Configure Terraform Cloud policy sets if using TFC",
            "Return clear violation messages to developers",
            "Allow policy exceptions with documented process",
            "Version and test policies like application code",
            "Gradually tighten policies (warn → soft-mandatory → hard-mandatory)",
            "Dashboard policy violation trends",
            "Document policy ownership and review cadence"
        ],
        security: "Policies themselves are version-controlled and reviewed; no bypass without audit.",
        scalability: "Policies apply uniformly across all Terraform runs in the organisation.",
        monitoring: "Policy evaluation results, violation counts, exception usage.",
        complexity: "Advanced."
    },
    {
        id: 69,
        platform: "Terraform",
        title: "Terraform Multi-Cloud Networking",
        description: "Unified networking across AWS, Azure, and GCP using Terraform modules for VPCs/VNets, VPN/Interconnect, and consistent tagging and routing.",
        difficulty: "Advanced",
        technologies: ["Terraform", "Multi-cloud", "AWS VPC", "Azure VNet", "GCP VPC", "VPN"],
        ...
        useCases: ["Hybrid multi-cloud strategies", "Disaster recovery across clouds", "Vendor-agnostic platform teams"],
        services: ["AWS VPC", "Azure Virtual Network", "Google VPC", "Cloud VPN / Interconnect", "Terraform"],
        implementationSteps: [
            "Define global CIDR and naming standards",
            "Create reusable modules per cloud provider",
            "Provision base networks on each cloud",
            "Implement cross-cloud connectivity (VPN or interconnect)",
            "Apply consistent tagging and labelling",
            "Configure routing and firewall rules",
            "Add monitoring and flow logs on each provider",
            "Test connectivity and failover scenarios",
            "Document cloud-specific limitations and workarounds",
            "Establish change management across clouds"
        ],
        security: "Encrypted transit, least-privilege security groups/NSGs/firewall rules, private connectivity preferred.",
    ...
    },// ---------- Agentic AI (9) ----------
    {
        ...
        useCases: ["Complex research pipelines", "Multi-step business processes", "Autonomous research agents"],
        services: ["LangGraph", "LangSmith", "Vector stores", "LLM providers"],
        implementationSteps: [
            "Define the shared state schema and typed messages",
            "Create specialized agent nodes (planner, researcher, critic, executor)",
            "Implement tool nodes and bind tools to agents",
            "Design conditional edges and routing logic",
            "Add checkpointing and persistence layer",
            "Implement human-in-the-loop interruption points",
            "Add observability with LangSmith or OpenTelemetry",
            "Write evaluation scenarios and regression tests",
            "Deploy as a FastAPI or serverless service",
            "Document agent responsibilities and failure modes"
        ],
        security: "Tool permission scoping, input/output guardrails, human approval for sensitive actions, rate limiting.",
        scalability: "Stateless graph execution with external checkpoint store; horizontal scaling of worker processes.",
        monitoring: "LangSmith traces, token usage, success/failure rates per node, latency per agent.",
        complexity: "Advanced."
    },
    {
        id: 71,
        ...
        useCases: ["Enterprise knowledge bases", "Technical support bots", "Research assistants"],
        services: ["Vector database (Pinecone / Weaviate / pgvector)", "Embedding models", "LLM APIs"],
        implementationSteps: [
            "Ingest and chunk documents with metadata",
            "Create embedding and hybrid retrieval pipelines",
            "Implement query rewriting and expansion logic",
            "Build ReAct or Plan-and-Execute agent loop",
            "Add self-reflection and answer critique steps",
            "Enforce citation and grounding requirements",
            "Implement fallback to web search when needed",
            "Evaluate with RAGAS or custom faithfulness metrics",
            "Add caching for frequent queries",
            "Deploy with streaming responses and source display"
        ],
        security: "Document-level access control, PII filtering, prompt injection defenses, output grounding checks.",
        scalability: "Async retrieval, caching layers, and batch embedding support large corpora.",
        monitoring: "Retrieval precision/recall, hallucination rate, citation accuracy, latency breakdown.",
        complexity: "Intermediate."
    },
    {
        id: 72,
        platform: "Agentic AI",
        title: "Tool-Using Autonomous Agent",
        ...
        useCases: ["Internal automation agents", "Customer support with backend actions", "Data enrichment pipelines"],
        services: ["LLM providers with tool calling", "Internal APIs", "Secret managers"],
        implementationSteps: [
            "Define tool schemas with strict typing and validation",
            "Implement safe tool execution layer with timeouts",
            "Bind tools to the LLM and configure parallel calling if supported",
            "Add authorization checks before side-effecting tools",
            "Handle tool errors and feed observations back to the agent",
            "Implement retry policies and circuit breakers",
            "Log every tool call with arguments and results",
            "Add human confirmation for high-impact tools",
            "Write unit and integration tests for tool paths",
            "Document tool catalog and permission model"
        ],
        security: "Least-privilege tool permissions, input validation, no direct shell access, audit logging of all actions.",
        scalability: "Stateless agent instances; tool backends scale independently.",
        monitoring: "Tool success/failure rates, latency per tool, token consumption, unauthorized attempt counts.",
        complexity: "Intermediate."
    },
    {
        id: 73,
        ...
        useCases: ["Automated bug fixing", "Feature implementation assistance", "Legacy code modernization"],
        services: ["LLM APIs", "Docker", "Git providers", "CI test runners"],
        implementationSteps: [
            "Create isolated Docker sandbox with code and tools",
            "Implement repository indexing and context retrieval",
            "Design planning and task decomposition prompts",
            "Give the agent controlled file and terminal tools",
            "Add test execution and result parsing",
            "Implement iteration loop with budget limits",
            "Generate clean commits and optional pull requests",
            "Add safety limits on destructive operations",
            "Evaluate on SWE-bench or internal task suites",
            "Document human review and takeover process"
        ],
        security: "Strict sandboxing, no network by default, resource limits, human review before merge.",
        scalability: "Parallel sandboxes per task; queue-based task distribution.",
        monitoring: "Task success rate, iterations to completion, test pass rate, token cost per task.",
        complexity: "Advanced."
    },
    {
        id: 74,
        platform: "Agentic AI",
        title: "Agentic DevOps Incident Response",
        ...
        useCases: ["SRE automation", "Reduced MTTR", "24/7 first-line response"],
        services: ["Observability backends", "Incident management tools", "Chat platforms", "LLM providers"],
        implementationSteps: [
            "Connect alert sources and normalize event schema",
            "Build investigation tools for metrics, logs, and traces",
            "Create triage and prioritization logic",
            "Implement root-cause analysis prompts with grounding",
            "Map common incidents to executable runbooks",
            "Add human approval gates for destructive actions",
            "Integrate with Slack or Microsoft Teams for collaboration",
            "Log all decisions and actions for post-mortems",
            "Measure MTTR improvement and false-positive rate",
            "Maintain a library of validated runbooks"
        ],
        security: "Read-only by default, explicit approval for changes, full audit trail, scoped credentials.",
        scalability: "Handles concurrent incidents via queue and multiple agent instances.",
        monitoring: "Time-to-triage, time-to-resolution, accuracy of suggestions, human override rate.",
        complexity: "Advanced."
    },
    {
        id: 75,
        ...
        useCases: ["SaaS support automation", "E-commerce help desks", "Internal IT service desks"],
        services: ["Ticketing systems", "CRM", "Knowledge bases", "LLM providers"],
        implementationSteps: [
            "Define agent roles and handoff protocols",
            "Build intent classification and routing logic",
            "Connect knowledge base with agentic retrieval",
            "Implement conversation memory and context window management",
            "Add escalation rules and human handoff",
            "Integrate ticket creation and update APIs",
            "Design response tone and brand guidelines",
            "Evaluate resolution rate and customer satisfaction",
            "Add feedback loop for continuous improvement",
            "Document escalation paths and agent boundaries"
        ],
        security: "PII redaction, access control to customer data, audit of all agent actions.",
        scalability: "Horizontal scaling of agent workers; queue-based conversation handling.",
        monitoring: "First-response time, resolution rate, escalation rate, CSAT correlation.",
        complexity: "Intermediate."
    },
    {
        id: 76,
        platform: "Agentic AI",
        title: "Long-Term Memory & Planning Agent",
        ...
        useCases: ["Personal AI assistants", "Project management agents", "Long-running research agents"],
        services: ["Vector databases", "Graph databases (optional)", "LLM providers"],
        implementationSteps: [
            "Design memory schema (episodic, semantic, procedural)",
            "Implement memory write, retrieve, and forget policies",
            "Build hierarchical goal and task representation",
            "Create planner that breaks goals into actionable steps",
            "Add progress tracking and status updates",
            "Implement reflection and self-critique loops",
            "Schedule periodic memory summarization",
            "Expose memory inspection and editing for users",
            "Evaluate goal completion rate over long horizons",
            "Document memory privacy and retention policies"
        ],
        security: "User-controlled memory, encryption at rest, clear data retention and deletion controls.",
        scalability: "Memory stores scale independently; agent instances remain stateless.",
        monitoring: "Goal completion rate, memory hit rate, planning depth, reflection impact.",
        complexity: "Advanced."
    },
    {
        id: 77,
        platform: "Agentic AI",
        title: "Secure Agent Deployment & Guardrails",
        ...
        useCases: ["Enterprise agent platforms", "Regulated industries", "Customer-facing agents"],
        services: ["Guardrail frameworks", "Policy engines", "Sandbox runtimes", "Secret managers"],
        implementationSteps: [
            "Classify tools by risk and define permission levels",
            "Implement input filtering and injection detection",
            "Add output guardrails for safety and brand compliance",
            "Sandbox all code execution and file system access",
            "Enforce runtime policies with OPA or similar",
            "Red-team the agent with known attack patterns",
            "Log every decision and tool call for audit",
            "Create incident response playbooks for agent misbehavior",
            "Regularly update guardrail models and rules",
            "Document threat model and residual risks"
        ],
        security: "Defense in depth, least privilege, continuous red-teaming, comprehensive audit trails.",
        scalability: "Guardrail checks are lightweight; sandboxes scale with demand.",
        monitoring: "Blocked actions, injection attempts, policy violations, false-positive rates.",
        complexity: "Advanced."
    },
    {
        id: 78,
        ...
        useCases: ["Production agent monitoring", "Regression testing of agent behavior", "Cost and quality optimization"],
        services: ["LangSmith / Phoenix / Helicone", "OpenTelemetry collectors", "Evaluation frameworks"],
        implementationSteps: [
            "Instrument agents with tracing and structured logging",
            "Capture full traces including prompts and tool results",
            "Define key quality metrics (task success, faithfulness, toxicity)",
            "Build offline evaluation datasets and golden sets",
            "Implement online evaluation sampling",
            "Create dashboards for latency, cost, and quality",
            "Set up alerts on quality or cost regressions",
            "Establish feedback loops from production to training data",
            "Version prompts and agent configurations",
            "Document evaluation methodology and acceptance criteria"
        ],
        security: "Redaction of sensitive data in traces, access control on observability platforms.",
        scalability: "Sampling and asynchronous evaluation keep overhead low at high volume.",
        monitoring: "Self-monitoring of the observability pipeline plus agent quality trends.",
        complexity: "Intermediate."
    }
];
...
const platformMeta = [
    ...
    { id: "GitHub Actions", name: "GitHub Actions", short: "GHA", description: "CI/CD automation, reusable workflows, security scanning and deployment pipelines.", iconClass: "platform-icon--gha", count: 10 },
    { id: "Terraform", name: "Terraform", short: "TF", description: "Infrastructure as Code, multi-cloud provisioning, modules and policy as code.", iconClass: "platform-icon--terraform", count: 9 },
    { id: "Agentic AI", name: "Agentic AI", short: "Agent", description: "Autonomous agents, multi-agent systems, tool use, memory, guardrails and evaluation.", iconClass: "platform-icon--agentic", count: 9 }
];
